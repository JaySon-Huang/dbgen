...
print('\n'.join(['    r_int{:03d} integer, '.format(x) + '/*{{ CASE rand.bool(0.05) WHEN TRUE THEN rand.range(0, 10000000) ELSE NULL END }}*/' for x in range(0, 290)]))
print('\n'.join(["    r_str{:03d} varchar(200), ".format(x) + "/*{{ CASE rand.bool(0.05) WHEN TRUE THEN rand.regex('[0-9a-zA-Z]{185,195}') ELSE NULL END }}*/" for x in range(0, 190)]))
